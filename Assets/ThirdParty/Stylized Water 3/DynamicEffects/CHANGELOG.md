...
Added:
- Menu options under GameObject > Effects > Water, to spawn various effect prefabs.

Changed:
- Shoreline Wave Spawner, added warning if Audio Source assigned uses the same Transform as the component.
- Water Raindrops prefab, revised to represent heavy rain.
